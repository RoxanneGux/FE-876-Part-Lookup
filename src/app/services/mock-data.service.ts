...
const EXTENDED_PARTS: ExtendedPartRecord[] = [
  { ...SIMPLE_PARTS[0], categoryId: 'CAT-ENG', categoryDescription: 'Engine Components', stockLocationId: 'LOC-MAIN', onHand: 15, onOrder: 5, committed: 3, requestOutPending: 1, manufacturerPartNumber: 'MFR-OP-601', manufacturer: 'Delphi', imageUrl: 'oil.svg' },
  { ...SIMPLE_PARTS[1], categoryId: 'CAT-ENG', categoryDescription: 'Engine Components', stockLocationId: 'LOC-MAIN', onHand: 42, onOrder: 0, committed: 8, requestOutPending: 0, manufacturerPartNumber: 'MFR-OG-602', manufacturer: 'Fel-Pro', imageUrl: 'oil.svg' },
  { ...SIMPLE_PARTS[2], categoryId: 'CAT-ENG', categoryDescription: 'Engine Components', stockLocationId: 'LOC-EAST', onHand: 8, onOrder: 10, committed: 2, requestOutPending: 0, manufacturerPartNumber: 'MFR-OS-603', manufacturer: 'Bosch', imageUrl: 'oil.svg' },
  { ...SIMPLE_PARTS[3], categoryId: 'CAT-ENG', categoryDescription: 'Engine Components', stockLocationId: 'LOC-MAIN', onHand: 120, onOrder: 50, committed: 15, requestOutPending: 3, manufacturerPartNumber: 'MFR-FLT-100', manufacturer: 'Fram', imageUrl: 'oil.svg' },
  { ...SIMPLE_PARTS[4], categoryId: 'CAT-ENG', categoryDescription: 'Engine Components', stockLocationId: 'LOC-WEST', onHand: 65, onOrder: 20, committed: 10, requestOutPending: 2, manufacturerPartNumber: 'MFR-CLN-50', manufacturer: 'Prestone', imageUrl: '' },
  { ...SIMPLE_PARTS[5], categoryId: 'CAT-ENG', categoryDescription: 'Engine Components', stockLocationId: 'LOC-MAIN', onHand: 200, onOrder: 0, committed: 25, requestOutPending: 0, manufacturerPartNumber: 'MFR-SP-200', manufacturer: 'NGK', imageUrl: '' },
  { ...SIMPLE_PARTS[6], categoryId: 'CAT-ENG', categoryDescription: 'Engine Components', stockLocationId: 'LOC-EAST', onHand: 18, onOrder: 12, committed: 4, requestOutPending: 1, manufacturerPartNumber: 'MFR-TB-300', manufacturer: 'Gates', imageUrl: '' },
  { ...SIMPLE_PARTS[7], categoryId: 'CAT-BRK', categoryDescription: 'Brake Components', stockLocationId: 'LOC-MAIN', onHand: 90, onOrder: 30, committed: 12, requestOutPending: 0, manufacturerPartNumber: 'MFR-BF-400', manufacturer: 'Castrol', imageUrl: 'brakes.svg' },
  { ...SIMPLE_PARTS[8], categoryId: 'CAT-BRK', categoryDescription: 'Brake Components', stockLocationId: 'LOC-WEST', onHand: 6, onOrder: 8, committed: 1, requestOutPending: 0, manufacturerPartNumber: 'MFR-BD-500', manufacturer: 'ACDelco', imageUrl: 'brakes.svg' },
  { ...SIMPLE_PARTS[9], categoryId: 'CAT-BRK', categoryDescription: 'Brake Components', stockLocationId: 'LOC-MAIN', onHand: 22, onOrder: 10, committed: 5, requestOutPending: 2, manufacturerPartNumber: 'MFR-FR-701', manufacturer: 'Brembo', imageUrl: 'brakes.svg' },
  { ...SIMPLE_PARTS[10], categoryId: 'CAT-BRK', categoryDescription: 'Brake Components', stockLocationId: 'LOC-EAST', onHand: 35, onOrder: 15, committed: 7, requestOutPending: 1, manufacturerPartNumber: 'MFR-FP-702', manufacturer: 'Wagner', imageUrl: '' },
  { ...SIMPLE_PARTS[11], categoryId: 'CAT-BRK', categoryDescription: 'Brake Components', stockLocationId: 'LOC-MAIN', onHand: 4, onOrder: 6, committed: 0, requestOutPending: 0, manufacturerPartNumber: 'MFR-FC-703', manufacturer: 'Cardone', imageUrl: '' },
  { ...SIMPLE_PARTS[12], categoryId: 'CAT-ELEC', categoryDescription: 'Electrical Components', stockLocationId: 'LOC-WEST', onHand: 10, onOrder: 3, committed: 2, requestOutPending: 0, manufacturerPartNumber: 'MFR-ALT-801', manufacturer: 'Denso', imageUrl: 'battery.svg' },
  { ...SIMPLE_PARTS[13], categoryId: 'CAT-ELEC', categoryDescription: 'Electrical Components', stockLocationId: 'LOC-EAST', onHand: 7, onOrder: 5, committed: 1, requestOutPending: 0, manufacturerPartNumber: 'MFR-SM-802', manufacturer: 'Remy', imageUrl: 'battery.svg' },
];
